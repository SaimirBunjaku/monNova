...
export function CartToast() {
  ...
  return (
    ...
    >
      <div
        className="pointer-events-auto flex w-full max-w-sm items-center gap-3 rounded-2xl border border-border/80 bg-surface/95 py-3 pl-3 pr-4 shadow-[0_8px_32px_rgba(22,21,26,0.12),0_0_0_1px_rgba(22,21,26,0.04)] backdrop-blur-md"
